...
This repository contains the prompt templates and paper-reported experimental settings accompanying the paper *DART-SQL: Dynamic Action Routing for Text-to-SQL*.

## Contents

- `prompts/`: the eight prompt templates used by the DART-SQL action modules and action selector.
- `settings/paper_reported_settings.yaml`: the DART-SQL and matched-baseline configuration reported in the camera-ready manuscript. The manuscript is the source of truth for these values.
